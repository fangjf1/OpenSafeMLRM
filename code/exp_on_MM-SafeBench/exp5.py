...
from transformers import AutoProcessor, Qwen2_5_VLForConditionalGeneration,LlavaNextProcessor, LlavaNextForConditionalGeneration,AutoModelForImageTextToText
...
"""
1、llama3-llava-next-8b-hf在text_only的的情况下测试
2、llama3-llava-next-8b-hf在jailbreak的的情况下测试
"""
...
# 模型封装接口定义
###############################################
# 1. llama3-llava-next-8b-hf
class Llama3_llava_next_8b_hf_text_only:
    def __init__(self, model_path="/root/autodl-tmp/models/llama3-llava-next-8b-hf/"):
...
class Llama3_llava_next_8b_hf_jailbreak:
    def __init__(self, model_path="/root/autodl-tmp/models/llama3-llava-next-8b-hf/"):
        self.model_id = model_path
        self.model = LlavaNextForConditionalGeneration.from_pretrained(
            self.model_id,
...
def run_experiments_text_only(
    ...
    # 逐个加载模型并处理所有场景
    models = [
        (Llama3_llava_next_8b_hf_text_only, "Llama3_llava_next_8b_hf_text_only"),
    ]
...
def run_experiments_jailbreak(
    ...
    # 逐个加载模型并处理所有场景
    models = [
        (Llama3_llava_next_8b_hf_jailbreak, "Llama3_llava_next_8b_hf_jailbreak"),
        (Llama3_llava_next_8b_hf_text_only, "Llama3_llava_next_8b_hf_text_only")
    ]
