...
from transformers import AutoProcessor, Qwen2VLForConditionalGeneration, Qwen2_5_VLForConditionalGeneration,AutoModelForImageTextToText


from qwen_vl_utils import process_vision_info

"""
1、Qwen2_VL_Instruct,Qwen2.5_VL_Instruct.在使用MM越狱方法的的情况下测试
2、Mulberry—llama和Mulberry-llava在使用MM越狱方法的的情况下测试
"""
