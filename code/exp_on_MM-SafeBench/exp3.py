...
"""
1、Qwen2_VL_Instruct.在text_only的情况下测试
2、3个RL模型:MM_Eureka_Qwen_7B,Mulberry_qwen2vl_7b,R1_Onevision_7B在text_only的情况下测试
"""
...
# 1. MM_Eureka_Qwen_7B
class MM_Eureka_Qwen_7B:
    def __init__(self, model_id="/root/autodl-tmp/models/MM-Eureka-Qwen-7B"):
        # 初始化模型和处理器
...
# 2. Mulberry_qwen2vl_7b
class Mulberry_qwen2vl_7b:
    def __init__(self, model_id="/root/autodl-tmp/models/Mulberry_qwen2vl_7b/"):
        # 初始化模型和处理器
        self.model_id = model_id
...
# 3. R1_Onevision_7B
class R1_Onevision_7B:
    def __init__(self, model_id="/root/autodl-tmp/models/R1-Onevision-7B"):
        self.model_id = model_id
...
class Qwen2_VL_7B_Instruct:
    def __init__(self, model_id="/root/autodl-tmp/models/Qwen2-VL-7B-Instruct"):
        # 初始化模型和处理器
        self.model_id = model_id
        self.model = Qwen2VLForConditionalGeneration.from_pretrained(
            self.model_id,
...
def run_experiments(
    ...
    # 逐个加载模型并处理所有场景
    models = [
        (R1_Onevision_7B, "R1_Onevision_7B"),
        (MM_Eureka_Qwen_7B, "MM_Eureka_Qwen_7B"),
        (Mulberry_qwen2vl_7b, "Mulberry_qwen2vl_7b"),
